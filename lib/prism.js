/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism-coy&languages=markup+css+clike+javascript+bash+c+csharp+cpp+cmake+css-extras+docker+git+go+java+json+makefile+markdown+markup-templating+matlab+objectivec+perl+php+python+qml+regex+ruby+rust+sql+swift+tcl+verilog+vhdl+yaml&plugins=line-highlight+line-numbers+inline-color */
